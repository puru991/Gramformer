...
setuptools.setup(
    ...
    install_requires=['transformers', 'sentencepiece==0.1.95', 'python-Levenshtein==0.12.2', 'fuzzywuzzy==0.18.0',  'tokenizers==0.7.0', 'fsspec==2021.5.0', 'lm-scorer==0.4.2', 'errant'],
    classifiers=[
